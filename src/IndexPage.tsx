...
export default function IndexPage(props: { goals: GoalPageProps[] }) {
    ...
    const pageDesc = "The United Nations' (UN) Sustainable Development Goals (SDGs) are a set of targets for global development adopted in September 2015, with targets set to be achieved by 2030. Here we present data across all available indicators from the Our World in Data database tracking progress towards these goals around the world."
    ...
    return <html>
        ...
        <body className="IndexPage">
            ...
            <div className="siteIntro container">
                ...
                <p>The United Nations' (UN) <a href="http://www.un.org/sustainabledevelopment/">Sustainable Development Goals</a> (SDGs) are a set of targets for global development adopted in September 2015, with targets set to be achieved by 2030. Here we present data across all available indicators from the <a href="https://ourworldindata.org">Our World in Data</a> database tracking progress towards these goals around the world.</p>
            </div>
            <nav>
                <div className="goals">
                    {goals.map(goal => 
