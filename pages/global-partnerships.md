...
<div class="indicator" id="17.8.1">
    <div class="row">
        <div class="col-md">
            ...
            <p><strong>More research:</strong> Further data and research on this topic is available at the <i>Our World in Data</i> entries on <a href="https://ourworldindata.org/technology-adoption">Technology Diffusion & Adoption</a> and <a href="https://ourworldindata.org/internet"> the Internet</a>.</p>
            <p><strong>Additional charts:</strong> <br><a href="https://ourworldindata.org/grapher/number-of-internet-users">Internet users by country</a>
...
<div class="indicator" id="17.11.1">
    <div class="row">
        ...
        <div class="col-md">
            <iframe src="https://ourworldindata.org/grapher/exports-of-goods-and-services-constant-2010-us?country=Low+income~Lower+middle+income~Middle+income~High+income~Upper+middle+income" style="width: 100%; height: 600px; border: 0px none;"></iframe>
        </div>
    </div>
</div>
